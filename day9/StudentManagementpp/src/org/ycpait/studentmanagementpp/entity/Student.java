...
public  class Student implements Serializable,Comparable<Student>{
	...
	private String name;
	private float marks;
	private List<String> subject;  // has a relationship
	...
	void display(String format) {
		...
		System.out.println();
		System.out.println(this.rollNumber+"   \t      "+this.name+" \t      "+this.marks+"   \t	this.subject");
...
//	}
	...
	public Student(String name, float marks,List<String>subject) {
	...
	public String toString()
	{
		...
		return this.rollNumber+"\t"+this.name+" \t"+this.marks +"\t"+this.subject ;
	}
...
//	
	...
	@Override
	 public int hashCode() {
		 System.out.println("In hashCode of Students");
